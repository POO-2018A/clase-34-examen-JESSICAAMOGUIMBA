...
public class VentanaPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Angulo formado entre los lados");
        ...
        cmbxFiguras.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Rectangulo", "Isosceles", "Escaleno", "Equilatero" }));
    ...
    private void btnCalcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCalcularActionPerformed
        ...
        if (cmbxFiguras.getSelectedItem().equals("Rectangulo")) {
            //area
            double ladoa = Double.parseDouble(txtLadoA.getText());
            double ladob = Double.parseDouble(txtLadoB.getText());
            double triangoloArea = calcularArea(ladoa,ladob);
            String resultado = String.valueOf(triangoloArea);
            txtResultados.setText("El Area del Triangulo Rectangulo es : "+resultado);
            //perimetero
            double ladoP1 = Double.parseDouble(txtLadoA.getText());
            double ladoP2 = Double.parseDouble(txtLadoB.getText());
            double ladoP3 = Double.parseDouble(txtLadoC.getText());
            double trianguloPerimetro = calcularPerimetro(ladoP1,0,0);
            String TrianguloP = String.valueOf(trianguloPerimetro);
            txtResultados.setText("El Perimetro del Triangulo Rectangulo es : "+TrianguloP );
            //altura
            
            
        } else if (cmbxFiguras.getSelectedItem().equals("Isosceles")) {
           
            
            
        } else if (cmbxFiguras.getSelectedItem().equals("Escaleno")) {
           
            
        } else if (cmbxFiguras.getSelectedItem().equals("Equilatero")) {
    ...
    private double calcularArea(double ladoa, double ladob) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    private double calcularPerimetro(double ladoP, int i, int i0) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
}
